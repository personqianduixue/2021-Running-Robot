...
def square_hole():
    ...
    while state == 8:  # 初始化
        ...
        if True:  # head发现黄色区域
            ...
            ChestOrg = np.rot90(ChestOrg_img)
            ChestOrg_copy = ChestOrg.copy()
            ...
            if cnt_keng is not None:
                ...
                box_blue = np.int0(cv2.boxPoints(rect_blue))  # 点的坐标box_blue
