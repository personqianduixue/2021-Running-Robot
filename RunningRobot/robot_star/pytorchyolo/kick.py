...
#################################################初始化#########################################################
camera_out = "chest"
#stream_head = "http://192.168.3.19:8082/?action=stream?dummy=param.mjpg"
cap_head = cv2.VideoCapture(2)
#stream_chest = "http://192.168.3.19:8080/?action=stream?dummy=param.mjpg"
    ...
    if True:
        if step == 0:   # 发现球,前进到球跟前
            ...
            if ball_y<410:
                ...
                print('step5 ball_y>470 Back1Run', ball_y)
            elif 410<ball_y<470:
                if ball_x>240:
                    ...
                    print('step5 410<ball_y<470 ball_x<200 Left1move', ball_x)
                elif 200<ball_x<240:
            ...
            if ball_y<420:
                ...
                action_append('Back1Run')
                print('step6 ball_y>470 Back1Run', ball_y)
            elif 420<ball_y<470:
                if ball_x>220:
                    action_append('Right1move')
