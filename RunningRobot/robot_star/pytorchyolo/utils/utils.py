...
def rescale_boxes(boxes, current_dim, original_shape):
    ...
    boxes_1[:, 0] = ((boxes[:, 0] - pad_x // 2) / unpad_w) * orig_w
    boxes_1[:, 1] = ((boxes[:, 1] - pad_y // 2) / unpad_h) * orig_h
    boxes_1[:, 2] = ((boxes[:, 2] - pad_x // 2) / unpad_w) * orig_w
    boxes_1[:, 3] = ((boxes[:, 3] - pad_y // 2) / unpad_h) * orig_h
    boxes_1[:, 4] = boxes[:, 4]
    boxes_1[:, 5] = boxes[:, 5]
    return boxes_1
