...
class Detector(object):
    ...
    def save_weights(self):
        torch.save(self.net.state_dict(), 'best.pkl', _use_new_zipfile_serialization=False)
...
if __name__=='__main__':
    ...
    detector.detect('./weights/best.pkl', '../end/images2/save/5/1.jpg')
    # detector.load_weights('./weights/best.pkl')
